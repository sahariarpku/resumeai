...
import { tailorResumeToJobDescription, improveResume, generateCoverLetter } from "@/lib/ai-flows-client";
...
export default function TailorResumePage() {
  ...
  const handleDownloadDoc = (content: string | null, baseFilename: string, type: string) => {
    if (!content) { toast({ title: "Download Error", description: `No ${type} content to download.`, variant: "destructive" }); return; }
    const filename = `${baseFilename.replace(/\s+/g, '_')}_${type.toLowerCase()}.doc`;
